  ...
  return (
    <div className="flex flex-col md:flex-row justify-between md:gap-20 mx-10 md:my-10 font-epilogue">
      <div className="w-full md:w-2/3 md:my-11">
        ...
        <ul className="list-inside list-disc ml-1">
          {RESPONSIBILITIES_DATA.map((item) => (
            <ResponsibilityItem description={item.description} />
          ))}
        </ul>
        <h1 className="text-2xl font-black font-poppins mt-8 mb-4">
        ...
        <ul className="list-disc ml-8">
          ...
          <li className="mt-3">
            <b>Passionate & Reliable:</b> Genuine interest in our mission and a
            strong desire to make a positive impact, responsible, and committed
            to fulfilling volunteer commitments.
          </li>
          <li className="mt-3">
            <b>Adaptable, Team Player & Strong Communication Skills:</b> Able to
            work effectively in diverse teams; and contributes
          ...
          <li className="mt-3">
            <b>Respectful:</b> Embraces diversity, inclusive, and treats others
            with respect. Abides with all our rules and regulations
          </li>
        </ul>
        <h1 className="text-2xl font-black font-poppins mt-8">When & Where</h1>
      ...
      <div className="divide-y divide-gray-300 w-full md:w-1/4">
        ...
        <div className="pt-6 mt-4">
          <h1 className="text-2xl font-black font-poppins">Required Skills</h1>
